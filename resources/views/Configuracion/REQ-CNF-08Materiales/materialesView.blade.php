...
@section('content')
    ...
    <form>
        <button type="submit" class="big" formaction="{{url('configuracion/crearmaterial')}}">Nuevo Material</button>
    ...
    <table class="table table-striped table-light" border="1">                
        @foreach ($t as $t)
            <tr>
                ...
                <td>
                    <form>
                        <button type="submit" class="small" formaction="{{url('configuracion/datosmaterial',[$t->id])}}">Ver</button>
                    </form>
                </td>
                <td>
                    <form>
                        <button type="submit" class="small" formaction="{{url('configuracion/editarmaterial',[$t->id])}}">Editar</button>
                    </form>
                </td>
            </tr>
        @endforeach

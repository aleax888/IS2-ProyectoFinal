...
@section('content')
    ...
    <form>
        <button type="submit" class="big" formaction="{{url('configuracion/crearevento')}}">Nuevo Evento</button>
    ...
    <table class="table table-striped table-light" border="1">                
        @foreach ($t as $t)
            <tr>
                ...
                <td>
                    <form>
                        <button type="submit" class="small" formaction="{{url('configuracion/datosevento',[$t->id])}}">Ver</button>
                    </form>
                </td>
                <td>
                    <form>
                        <button type="submit" class="small" formaction="{{url('configuracion/adaptarevento',[$t->id])}}">Adaptar</button>
                    </form>
                </td>
                <td>
                    <form>
                        <button type="submit" class="small" formaction="{{url('configuracion/editarevento',[$t->id])}}">Editar</button>
                    </form>                    
                </td>
            </tr>
        @endforeach
